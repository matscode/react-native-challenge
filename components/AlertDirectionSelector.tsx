  ...
  return (
    <View className="flex-row bg-gray-100 rounded-xl p-1 h-[54px]">
      <Pressable 
        ...
        className={`flex-1 flex-row items-center justify-center rounded-lg gap-2 ${value === 'above' ? 'bg-white' : ''}`}
        testID="direction-above"
      >
      ...
      <Pressable 
        ...
        className={`flex-1 flex-row items-center justify-center rounded-lg gap-2 ${value === 'below' ? 'bg-white' : ''}`}
        testID="direction-below"
      >
